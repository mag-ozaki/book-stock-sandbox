...
class BookPolicyTest extends TestCase
{
    ...
    public function test_owner_can_view_any_book(): void
    {
        $this->assertTrue($this->policy->viewAny($this->makeOwner()));
    }

    public function test_employee_can_view_any_book(): void
    {
    ...
    public function test_owner_can_view_book(): void
    {
        $this->assertTrue($this->policy->view($this->makeOwner(), new Book()));
    }

    public function test_employee_can_view_book(): void
    {
        $this->assertTrue($this->policy->view($this->makeEmployee(), new Book()));
    }
    ...
    {
        $this->assertTrue($this->policy->update($this->makeOwner(), new Book()));
    }

    public function test_employee_can_update_book(): void
    {
        $this->assertTrue($this->policy->update($this->makeEmployee(), new Book()));
    }
    ...
    {
        $this->assertTrue($this->policy->delete($this->makeOwner(), new Book()));
    }

    public function test_employee_can_delete_book(): void
    {
        $this->assertTrue($this->policy->delete($this->makeEmployee(), new Book()));
    }
}
