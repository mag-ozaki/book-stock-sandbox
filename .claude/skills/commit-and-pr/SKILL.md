...
現在のブランチを確認する。`develop` または `main` ブランチの場合は「現在 <ブランチ名> ブランチにいます。feature/* や fix/* などのブランチを切ってから作業してください」と伝えて中止する。
...
「push して PR を作成してよいですか？」と確認する。ユーザーが否定した場合はコミットのみで終了する。
